...
if( isset( $_POST["add"] ) ) {
        ...
        if( !$_POST["username"] ) {
            $nameError = "Please enter your user name. <br>";
        } else {
...
values (NULL,'jacksonsmith','abc123','jack@son.com',CURRENT_TIMESTAMP,'Hello! I\'m Jackson. This
is my bio.');
*/       

	if( $username && $email && $password) {        
		$query="INSERT INTO users(id,username,password,email,signup_date,biography) 
	values (NULL,'$username','$password','$email',CURRENT_TIMESTAMP,'$biography')";
