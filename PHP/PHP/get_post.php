...
<html>
    ...
    <body>
        <div class="container">
            ...
            <!-- GET Method is not secure as data is written on HTTP URL -->
            ...
            <!-- USE POST Method to submit data as you can hide data -->
            ...
            <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post">
                ...
                <input type="text" placeholder="Name" name="post-name"><br><br>
